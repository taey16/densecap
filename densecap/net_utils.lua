...
function net_utils.load_inception(name, backend, path_offset)
  ...
  vision_encoder:remove(22)
  vision_encoder:remove(21)
  vision_encoder:remove(20)
  vision_encoder:remove(19)
  vision_encoder:remove(18)
  vision_encoder:remove(17)
  vision_encoder:remove(16) -- 3x720x720 -> 768x43x43 
...
function net_utils.load_cnn(name, backend, path_offset)
  ...
  if name == 'vgg-16' then
    ...
    proto_file = '/storage/ImageNet/ILSVRC2012/model/vgg/prototxt/vgg_layer16_deploy.prototxt'
    model_file = '/storage/ImageNet/ILSVRC2012/model/vgg/model/vgg_layer16.caffemodel'
  else
