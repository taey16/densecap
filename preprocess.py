...
if __name__ == '__main__':
  ...
  parser.add_argument('--region_data',
      default='/data2/visualgenome/region_descriptions.json',
      help='Input JSON file with regions and captions')
  parser.add_argument('--image_dir',
      default='/data2/visualgenome/images/',
  ...
  parser.add_argument('--json_output',
      default='/data2/visualgenome/regions_descriptions.json.json',
      help='Path to output JSON file')
  parser.add_argument('--h5_output',
      default='/data2/visualgenome/regions_descriptions.json.h5',
